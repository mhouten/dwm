...
static char selbordercolor[] = "#228B22";
...
static Key keys[] = {
	...
	{MODKEY, XK_Print, spawn, SHCMD("mpv --no-cache --no-osc --no-input-default-bindings --profile=low-latency --input-conf=/dev/null --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)")},
	...
	// E460 Media
	{0, XF86XK_Explorer, spawn, SHCMD(TERMINAL "-e lf")},
	{0, XF86XK_LaunchA, spawn, SHCMD("arandr")},
	{0, XF86XK_Search, spawn, SHCMD("dmenu_run")},
	{0, XF86XK_Tools, spawn, SHCMD("lxappearance")},
	// {0, XF86XK_WLAN, spawn, SHCMD("")},
	{0, XF86XK_Display, spawn, SHCMD("dmenurecord")},
	{MODKEY, XF86XK_Display, spawn, SHCMD("dmenurecord kill")},
